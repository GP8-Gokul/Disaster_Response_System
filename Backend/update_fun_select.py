...
def update_interface(data):
    try:
        ...
        if table == "disaster_events":
            ...
            result = update_volunteer(table, data.get("volunteer_id"), data.get("name"), data.get("contact_info"), data.get("skills"), data.get("availability_status"), data.get("event_id"))
